...
**Известный нюанс:** API возвращает другое число контактов, чем `contacts.list` в JSON-экспорте. На реальном дампе пользователя — 2108 vs 2911. API возможно фильтрует только mutual / non-blocked / non-deleted. Разберёмся в День 3-А.
